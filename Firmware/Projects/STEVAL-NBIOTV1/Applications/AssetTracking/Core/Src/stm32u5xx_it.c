...
void EXTI0_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(LIS2DUXS12_INT1_Pin);
...
void EXTI1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(LIS2DUXS12_INT2_Pin);
...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(INT_EX_Pin);
...
void EXTI3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BOOT0_USR_Pin);
...
void EXTI11_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(LPS22DF_INT_Pin);
