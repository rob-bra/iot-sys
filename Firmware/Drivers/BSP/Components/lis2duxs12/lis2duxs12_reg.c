...
/**
  ...
  *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~MINE~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  * lis2duxs12_mlc_out_get: Lettura registro MLC1_src(LIS2DUXS12_MLC1_SRC = 0x34U)
  *
  * @param ctx = dev_ctx_accel:  variabile di contesto del sensore accelerometro, già inizializzata
  * @param buff = mlc_src:  variabile in cui viene salvato il valore letto dal registro MLC1_SRC - buffer uint8_t
  */
